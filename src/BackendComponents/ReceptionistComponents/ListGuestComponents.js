...
const RListGuestComponent = () => {
    ...
    return (
        ...
        <div className = "container">
            ...
            <Link to = "/Radd-guest" className = "btn btn-primary mb-2" > Add Guest </Link>
                ...
                <tbody>
                    {
                        guest.map(
                            ...
                            <tr key = {guest.id}> 
                                ...
                                <td>{guest.address}</td>
                                <td>
                                    <Link className="btn btn-info" to={`/Rupdateguest/${guest.id}`} >Update</Link>
...
export default RListGuestComponent
