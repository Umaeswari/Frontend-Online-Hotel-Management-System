...
export const MAddInventoryReportsComponents = () => {
    ...
    const title = () => {
        ...
        if(id){
            return <h2 className = "text-center">MUpdate InventoryReports</h2>
        }else{
            return <h2 className = "text-center">MAdd InventoryReports</h2>
        }
    }
    return (
        <div>
